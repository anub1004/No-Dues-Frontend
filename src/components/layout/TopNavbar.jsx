...
export default function TopNavbar({ onMenuClick, title }) {
  ...
  return (
    <header className="bg-white border-b border-slate-200 px-4 lg:px-6 py-3 flex items-center gap-4 sticky top-0 z-30 shadow-sm">
      ...
      <button
        onClick={onMenuClick}
        className="text-slate-600 hover:text-slate-900 md:hidden p-2 hover:bg-slate-100 rounded-lg transition-all"
      >
        <Menu size={20} />
      </button>
      ...
      <div className="flex items-center gap-1">
        ...
        <div className="relative">
          ...
          >
            <div className="w-7 h-7 bg-gradient-to-br from-slate-900 to-teal-600 text-white rounded-lg flex items-center justify-center text-xs font-bold">
          ...
          {dropdownOpen && (
            <>
              ...
              <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-lg shadow-lg border border-slate-200 py-2 z-20 animate-fade-in">
